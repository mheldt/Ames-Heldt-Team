 ...
 * @author MarkH
 */
public class IronClad implements Serializable{
    ...
    public String toString() {
        return "IronClad{" + "fuelType=" + fuelType + ", shipLength=" + shipLength + ", shipWidth=" + shipWidth + ", shipHeight=" + shipHeight + ", shipWeight=" + shipWeight + '}';
    }

    @Override
    public int hashCode() {
        int hash = 3;
        hash = 67 * hash + Objects.hashCode(this.fuelType);
        hash = 67 * hash + Objects.hashCode(this.shipLength);
        hash = 67 * hash + Objects.hashCode(this.shipWidth);
        hash = 67 * hash + Objects.hashCode(this.shipHeight);
        hash = 67 * hash + Objects.hashCode(this.shipWeight);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final IronClad other = (IronClad) obj;
