 ...
 * @author MarkH
 */
public class Dirigible implements Serializable{
    ...
    public String toString() {
        return "Dirigible{" + "fuelType=" + fuelType + ", shipLength=" + shipLength + ", shipWidth=" + shipWidth + ", shipHeight=" + shipHeight + ", shipWeight=" + shipWeight + '}';
    }
    ...
    public boolean equals(Object obj) {
        ...
        final Dirigible other = (Dirigible) obj;
