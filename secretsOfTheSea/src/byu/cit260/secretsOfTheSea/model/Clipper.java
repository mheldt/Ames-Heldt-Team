...
public class Clipper implements Serializable{
    ...
    public void setShipHeight(Double shipHeigth) {
        this.shipHeight = shipHeigth;
    }
    ...
    public String toString() {
        return "Clipper{" + "fuelType=" + fuelType + ", shipLength=" + shipLength + ", shipWidth=" + shipWidth + ", shipHeigth=" + shipHeight + ", shipWeight=" + shipWeight + '}';
    }

    @Override
    public int hashCode() {
        int hash = 5;
        hash = 79 * hash + Objects.hashCode(this.fuelType);
        hash = 79 * hash + Objects.hashCode(this.shipLength);
        hash = 79 * hash + Objects.hashCode(this.shipWidth);
        hash = 79 * hash + Objects.hashCode(this.shipHeight);
        hash = 79 * hash + Objects.hashCode(this.shipWeight);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final Clipper other = (Clipper) obj;
